...
<body>
      ...
      <aside>
            ...
            <header>
                  ...
                  <div class="user">Indah Meilina</div>
            </header>
                  ...
                  <ul>
                        ...
                        <li>
                              <a href="index.php?hal=alb_tampil">
                                    <img class="icon" src="layouts/assets/img/menu.png" alt=""> Album
                              </a>
                        </li>
                  </ul>
            </nav>
      ...
      <main>
            ...
            <footer>
                  Copyright &copy; 2023. Designed by Indah Meilina
            </footer>
      </main>
